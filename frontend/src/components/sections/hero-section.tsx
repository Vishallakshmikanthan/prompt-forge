...
export function HeroSection() {
    const words = [
        ...
        { text: "Prompts.", className: "text-accent dark:text-accent" },
    ];
        ...
        <AuroraBackground className="pt-24 pb-32 w-full">
            ...
            >
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-border bg-background/50 backdrop-blur-xl shadow-sm mb-8 hover:bg-muted/50 transition-colors cursor-pointer group">
                    ...
                    <span className="text-sm font-medium tracking-wide">PromptForge Platform v2.0</span>
                </div>

                <div className="font-display max-w-4xl mx-auto mb-6">
                ...
                >
                    The ultimate platform for developers to browse, upload, fork, and manage structured prompts for AI-assisted development.
                </motion.p>
