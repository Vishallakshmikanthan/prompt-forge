...
export function HeroAscii() {
    ...
    return (
        <main className="relative min-h-[80vh] overflow-hidden bg-black border-y border-white/10">
            ...
            <div className="absolute top-0 left-0 right-0 z-20 border-b border-white/20">
                <div className="container mx-auto px-4 lg:px-8 py-3 lg:py-4 flex items-center justify-between">
                    <div className="flex items-center gap-2 lg:gap-4">
                        ...
                        <span className="text-white/60 text-[8px] lg:text-[10px] font-mono whitespace-nowrap">AI Prompt Platform</span>
                    </div>
            ...
            {/* CTA Content */}
            <div className="relative z-10 flex min-h-[80vh] items-center justify-end pt-16 lg:pt-0">
                <div className="w-full lg:w-1/2 px-6 lg:px-16 lg:pr-[10%]">
                    <div className="max-w-lg relative lg:ml-auto">
                        ...
                        <div className="relative">
                            ...
                            <h1 className="text-2xl lg:text-4xl font-bold text-white mb-3 lg:mb-4 leading-tight font-mono tracking-wider lg:-ml-[5%]" style={{ letterSpacing: '0.05em' }}>
                        ...
                        <div className="relative">
                            <p className="text-xs lg:text-base text-gray-300 mb-5 lg:mb-6 leading-relaxed font-mono opacity-80">
                                Discover, test, and share high-quality prompts used by developers and researchers across the world.
                            </p>
                        ...
                        <div className="hidden lg:flex items-center gap-2 mt-6 opacity-40">
                            ...
                            <div className="flex-1 h-px bg-white"></div>
                            <span className="text-white text-[9px] font-mono font-bold tracking-tighter">PROMPTFORGE.PROTOCOL</span>
                        </div>
                    </div>
                </div>
            </div>
